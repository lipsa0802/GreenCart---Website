    ...
    return product && (
        <div className="mt-12">
                ...
                <div className="flex gap-3">
                    <div className="flex flex-col gap-3">
                        {product.image.map((image, index) => (
                            <div key={index} onClick={() => setThumbnail(image)} className="border max-w-24 border-gray-500/30 rounded
                ...
                <div className="text-sm w-full md:w-1/2">
                    ...
                    <div className="flex items-center gap-0.5 mt-1">
                        {Array(5).fill('').map((_, i) => (
                         <img src={ i<4 ? assets.star_icon: assets.
                                    star_dull_icon} alt="" className="md:w-4 w-3.5"/>
                    ...
                    <div className="mt-6">
                        ...
                        {product.price}</p>
                        <p className="text-2xl font-medium">MRP:  {currency}{product.
                        offerPrice}</p>
            ...
            <div className=" flex flex-col items-center mt-20">
                ...
                rounded text-primary hover:bg-primary/10 transition">SeeMore</button>
            </div>
        </div>
    );
};
